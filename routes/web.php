...
// Quen mat khau
Route::get('/forgot-password',[AuthController::class, 'ShowForgetPasswordForm'])->name('auth.forgetPassword');

Route::post('/forgot-password',[AuthController::class, 'SubmitForgotPasswordForm'])->name('auth.SubmitForgotPassword');

Route::get('/reset-password/{token}',[AuthController::class, 'ShowResetPasswordForm'])->name('auth.ShowResetPassword');
