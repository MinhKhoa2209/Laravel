<header class="bg-white shadow fixed top-0 left-0 w-full h-24 z-50 overflow-visible">
    <div class="container mx-auto flex items-center h-full px-3">
        ...
        <a href="{{ route('pages.wishlist') }}" class="relative text-gray-700 hover:text-black-500">
            ...
            <span class="wishlist-count absolute -top-2 -right-2 bg-red-500 text-white text-xs font-bold px-1.5 py-0.5 rounded-full" style="display: {{ $wishlistCount > 0 ? 'inline-block' : 'none' }};">
                {{ $wishlistCount }}
            </span>
        </a>
        ...
        <a href="{{ route('pages.cart') }}" class="relative text-gray-700 hover:text-black-500">
            ...
            <span class="cart-count absolute -top-2 -right-2 bg-red-500 text-white text-xs font-bold px-1.5 py-0.5 rounded-full" style="display: {{ $cartCount > 0 ? 'inline-block' : 'none' }};">
                {{ $cartCount }}
            </span>
        </a>
