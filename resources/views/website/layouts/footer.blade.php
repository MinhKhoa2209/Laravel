...
<div class="bg-gray-800">
    <div class="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
        <div class="p-5">
            <h3 class="font-bold text-xl text-cyan-300">Mixi Shop</h3>
        </div>
        <div class="p-5">
...
<<<<<<< HEAD
            ...
            <a class="my-3 block text-white hover:bg-gray-200 hover:bg-transparent border-0 hover:text-gray-400 "
            href="{{ route('pages.about') }}">Introduction<span class="text-teal-600 text-xs p-1"></span></a>
            <a class="my-3 block text-white hover:bg-gray-200 hover:bg-transparent border-0 hover:text-gray-400 "
            href="{{route('collections.all-products')}}" >Products <span class="text-teal-600 text-xs p-1">New</span></a>
            <a class="my-3 block text-white hover:bg-gray-200 hover:bg-transparent border-0 hover:text-gray-400 "
...
<<<<<<< HEAD
            ...
            <a class="my-3 block text-white hover:bg-gray-200 hover:bg-transparent border-0 hover:text-gray-400 "
            href="{{route('pages.terms_of_service')}}">Terms of Service <span class="text-teal-600 text-xs p-1"></span></a>
        </div>
        <div class="p-5">
            <div class="text-sm uppercase text-cyan-300 font-bold">Contact us</div>
            <span class="my-3 block text-white "
